function Classifier
    ...
    nbImagesVOCBuilding = 200; % Number of images processed in VOCBuilding, Max value at -1
    nbImagesClsTraining = 200; % Number of images used to train the classifier, Max value at -1
...
function model = ClassifierTraining(VOCopts, classifier, ids)
    ...
    fprintf('Training of classifier\n');
    drawnow;
